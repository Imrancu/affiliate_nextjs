    ...
    return (
        <div className="lg:flex lg:justify-between lg:items-center w-full lg:px-10 px-5 lg:py-20 py-7 bg-gradient-to-r from-secondary to-midnight">
            <div className="lg:w-1/2">
                <h1 className="text-5xl leading-snug text-color tracking-wide">We Make Better <span className="text-primary font-bold">Products</span> <br /> <span className="text-primary font-bold">You</span> Get Better Result</h1>
                <p className="text-silver tracking-wide my-9">Find the Latest Trends and Must-Have Items, a powerful statement that captures the essence of staying up-to-date with the ever-changing fashion landscape.</p>
